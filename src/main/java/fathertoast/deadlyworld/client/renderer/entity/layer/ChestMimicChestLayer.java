...
public class ChestMimicChestLayer extends RenderLayer<ChestMimic, ChestMimicModel> {
    ...
    private static final ResourceLocation VANILLA_TEXTURE = new ResourceLocation( "textures/entity/chest/normal.png" );
    ...
    private static ResourceLocation[] createCommonLocations( ResourceLocation blockId ) {
        ...
        consideredPaths[ 0 ] = new ResourceLocation( blockId.getNamespace(), "textures/model/" + blockId.getPath() + ".png" );
        consideredPaths[ 1 ] = new ResourceLocation( blockId.getNamespace(), "textures/entity/chest/" + blockId.getPath() + ".png" );
        consideredPaths[ 2 ] = new ResourceLocation( blockId.getNamespace(), "textures/entity/chest/" + blockId.getPath().replaceFirst( "_chest", "" ) + ".png" );
