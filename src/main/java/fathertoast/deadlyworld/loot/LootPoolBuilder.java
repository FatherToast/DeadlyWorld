...
class LootPoolBuilder
{
	...
	// Contition removed - makes no sense in the context of blocks and chests
	...
	public static final LootCondition[] UNCOMMON_CONDITIONS = {
		new RandomChanceWithLooting( 0.25F, 0.1F )//, KILLED_BY_PLAYER_CONDITION
	};
	public static final LootCondition[] RARE_CONDITIONS     = {
		new RandomChanceWithLooting( 0.025F, 0.01F )//, KILLED_BY_PLAYER_CONDITION
	};
	public static final LootCondition[] EPIC_CONDITIONS     = {
		new RandomChanceWithLooting( 0.0F, 0.015F )//, KILLED_BY_PLAYER_CONDITION
	};
