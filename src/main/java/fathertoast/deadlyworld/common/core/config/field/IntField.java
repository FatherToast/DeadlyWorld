...
public class IntField extends AbstractConfigField {
        ...
        if( raw instanceof Number ) {
            ...
            if( rawValue < valueMin ) {
                ...
                if( (double) rawValue != ((Number) raw).doubleValue() ) {
                    DeadlyWorld.LOG.warn( "Value for {} \"{}\" is not an integer! Truncating value. Invalid value: {}",
                            getClass(), getKey(), raw );
                }
                newValue = rawValue;
            }
            ...
            DeadlyWorld.LOG.info( "Unboxing string value for {} \"{}\" to a different primitive.",
                    getClass(), getKey() );
            ...
            if( raw != null ) {
                DeadlyWorld.LOG.warn( "Invalid value for {} \"{}\"! Falling back to default. Invalid value: {}",
                        getClass(), getKey(), raw );
            }
    ...
    public static class RandomRange {
        ...
        public int next( Random random ) {
            ...
            if( delta < 0 ) {
                DeadlyWorld.LOG.warn( "Value for range \"({},{})\" is invalid ({} > {})! Ignoring maximum value.",
