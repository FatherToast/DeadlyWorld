...
public final class DWSoundEvents {
    ...
    public static final RegistryObject<SoundEvent> SPIKE_TRAP_CLICK = register( "block.spike_trap.click" );
    
    public static final RegistryObject<SoundEvent> SEA_MINE_ARMING = register( "block.sea_mine.arming" );
