...
public interface ISpawnerObject {
    ...
    void sendUpdate( ProgressiveDelaySpawner spawner, Level level, BlockPos pos );
    
    default void broadcastEvent( ProgressiveDelaySpawner spawner, Level level, BlockPos pos, int eventId ) { }
