...
public enum TowerType {
    ...
    SIMPLE( "simple", ( dimConfig ) -> dimConfig.TOWER_DISPENSERS.SIMPLE ) {
        //        @Override
        //        public void triggerAttack( DimensionConfigGroup dimConfig, TowerDispenserBlockEntity tileEntity, PlayerEntity target,
    ...
    //    public abstract void triggerAttack( DimensionConfigGroup dimConfig, TowerDispenserBlockEntity tileEntity, PlayerEntity target,
    //                                        Vector3d center, Vector3d offset, Vector3d vecToTarget, double distanceH );
