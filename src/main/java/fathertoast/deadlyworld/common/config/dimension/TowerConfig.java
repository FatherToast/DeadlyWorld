...
public class TowerConfig extends FeatureConfig {
    ...
    TowerConfig( ConfigManager manager, String dir, DimensionConfigGroup dimConfigs ) {
        ...
        SIMPLE = new TowerTypeCategory( this, TowerType.SIMPLE, isNether ? 0.2 : 0.3, DEPTH_LAVA, DEPTH_0,
                11.0, true, 20, 40, 3.0, 1.2, 0.08 );
        
        FIRE = new TowerTypeCategory( this, TowerType.FIRE, isNether ? 0.075 : 0.1, DEPTH_LAVA, DEPTH_0,
                9.0, true, 20, 40, 1.0, 1.0, 0.1 );
        
        POTION = new PotionTowerTypeCategory( this, TowerType.POTION, isNether ? 0.075 : 0.1, DEPTH_LAVA, DEPTH_0,
                9.0, true, 30, 50, 2.0, 1.0, 0.08,
                0.2 );
        
        GATLING = new TowerTypeCategory( this, TowerType.GATLING, isNether ? 0.075 : 0.1, DEPTH_LAVA, DEPTH_0,
                9.0, true, 6, 8, 1.0, 1.0, 0.2 );
        
        FIREBALL = new TowerTypeCategory( this, TowerType.FIREBALL, isNether ? 0.07 : 0.05, DEPTH_LAVA, DEPTH_0,
