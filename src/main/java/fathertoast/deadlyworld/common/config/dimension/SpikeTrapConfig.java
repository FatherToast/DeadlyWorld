...
public class SpikeTrapConfig extends FeatureConfig {
    ...
    SpikeTrapConfig( ConfigManager manager, String dir, DimensionConfigGroup dimConfigs ) {
        ...
        MUNDANE = new SpikeTrapConfig.SpikeTrapTypeCategory( this, SpikeTrapType.MUNDANE, 0.15, DEPTH_LAVA, DEPTH_0,
                3.0F, 20, 5, 2 );
        
        POISON = new SpikeTrapConfig.PotionSpikeTrapTypeCategory( this, SpikeTrapType.POISON, 0.05, DEPTH_LAVA, DEPTH_0,
                2.0F, 20, 5, 2, 200, 0 );
        
        FIERY = new SpikeTrapConfig.FierySpikeTrapTypeCategory( this, SpikeTrapType.FIERY, 0.15, DEPTH_LAVA, DEPTH_0,
                2.0F, 20, 5, 2, 6 );
        
        WITHERING = new SpikeTrapConfig.PotionSpikeTrapTypeCategory( this, SpikeTrapType.WITHERING, 0.05, DEPTH_LAVA, DEPTH_0,
                2.0F, 20, 5, 2, 140, 0 );
        
        MECHANICAL_MUNDANE = new SpikeTrapConfig.SpikeTrapTypeCategory( this, SpikeTrapType.MECHANICAL_MUNDANE, 0.15, DEPTH_LAVA, DEPTH_0,
                4.0F, 20, 5, 2 );
        
        MECHANICAL_POISON = new SpikeTrapConfig.PotionSpikeTrapTypeCategory( this, SpikeTrapType.MECHANICAL_POISON, 0.05, DEPTH_LAVA, DEPTH_0,
                3.0F, 20, 5, 2, 100, 1 );
        
        MECHANICAL_FIERY = new SpikeTrapConfig.FierySpikeTrapTypeCategory( this, SpikeTrapType.MECHANICAL_FIERY, 0.15, DEPTH_LAVA, DEPTH_0,
                3.0F, 20, 5, 2, 4 );
        
        MECHANICAL_WITHERING = new SpikeTrapConfig.PotionSpikeTrapTypeCategory( this, SpikeTrapType.MECHANICAL_WITHERING, 0.05, DEPTH_LAVA, DEPTH_0,
                3.0F, 20, 5, 2, 80, 1 );
    }
