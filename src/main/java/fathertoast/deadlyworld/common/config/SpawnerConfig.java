...
public class SpawnerConfig extends FeatureConfig {
    ...
    public static class SpawnerTypeCategory extends FeatureTypeCategory {
        ...
        SpawnerTypeCategory( FeatureConfig parent, SpawnerType type,
            ...
            activationRange = SPEC.define( new DoubleField( "activation_range", activationRng, DoubleField.Range.NON_NEGATIVE,
            ...
            delayProgression = SPEC.define( new IntField( "delay.progression", delayPrgr, IntField.Range.NON_NEGATIVE,
                    "Each spawn increases the spawner's delay buildup by this many ticks (" + ConfigUtil.PLUS_OR_MINUS +
                            "10%). Set this to 0 to",
            ...
            spawnRange = SPEC.define( new DoubleField( "spawn_range", spawnRng, DoubleField.Range.NON_NEGATIVE,
