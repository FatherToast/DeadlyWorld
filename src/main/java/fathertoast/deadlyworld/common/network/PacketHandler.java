...
public class PacketHandler {
    ...
    public final void registerMessages() {
        registerMessage(S2CUpdateSpawnerRenderEntity.class, S2CUpdateSpawnerRenderEntity::encode, S2CUpdateSpawnerRenderEntity::decode, S2CUpdateSpawnerRenderEntity::handle);
    }
