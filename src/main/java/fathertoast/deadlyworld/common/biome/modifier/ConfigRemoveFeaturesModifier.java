 ...
 */
public record ConfigRemoveFeaturesModifier( BooleanFieldSetting enabled, HolderSet<Biome> biomes, HolderSet<PlacedFeature> features, Set<GenerationStep.Decoration> steps )
