...
public abstract class DWAbstractModelProvider extends BlockStateProvider {
    ...
    protected void spikeTrap( RegistryObject<? extends Block> regObj,
    ...
    protected void spikeTrap( RegistryObject<? extends Block> regObj, ResourceLocation baseTexture, ResourceLocation spikeTexture ) {
