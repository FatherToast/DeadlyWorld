...
public class DWBlockLootTables extends VanillaBlockLoot { // Extending vanilla block loot to copy all "explosion resistant" items
    ...
    public void generate() {
        ...
        for( SpikeTrapType type : SpikeTrapType.values() ) {
            dropSelf( DWBlocks.spikeTrap( type ).get() );
        }
    ...
    private LootTableBuilder buildFloorTrapLoot( FloorTrapType type ) {
        ...
        switch( type ) {
            ...
            case SEA_MINE_MOB -> loot.addPool( buildWaterTrapLootPool() );
            default ->
    ...
    private LootPool.Builder buildWaterTrapLootPool() {
        return floorTrapLootPoolBuilder()
                ...
                .addItemClusterSmall( Items.PRISMARINE, 6 )
                .addItemClusterSmall( Items.SEA_PICKLE, 10 )
                .toLootPool();
    }
